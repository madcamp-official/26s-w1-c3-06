...
### Keep
- front/back 등 역할을 나눠 명세를 기준으로 협업하기
- IA, ERD, figma로 먼저 서비스 구조를 시각화하기
- github를 사용해 변경사항 통합하기
- 문제 발생시 log 확인하며 원인 추적하기

### Problem
- 데이터 형식 및 변수명 불일치
- 로컬과 배포 환경에서 실행 방식이 달라 수정사항이 많았음

### Try
- 개발 시작 전 api 형식을 먼저 명확히 정의하고 공유하여 혼선 발생 막기
- 로컬 개발시 배포할 것 고려해서 경로 및 변수 등을 일관되게 구성하기
- 브랜치 생성 및 merge 익숙해지기 
---
