...
- **주제: 가상자산 주식 모의투자 어플리케이션**
- **목적: 주식 투자에 관심이 있으나 법령상, 재정상의 문제로 실거래가 불가능하거나, 실습 위주의 경제 학습을 체험해보고자 하는 청소년 전용으로 개발됨**
- **핵심 기능: 가상계좌 생성, 실제 기업과 실시간으로 연동되는 주가 추종, 가상주식 매매, 수익 순위표 **
- **예상 사용자: **
