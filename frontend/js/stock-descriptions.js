/**
 * stock-descriptions.js — DB 없이 프론트에서만 관리하는 종목 한 줄 설명
 *
 * 사용법: 화면에서 이 파일을 먼저 불러온 다음,
 *   getStockDesc("삼성전자")  ->  "반도체와 스마트폰을 만드는 회사"
 *   매핑에 없는 종목이면 빈 문자열("")을 반환 (화면에서 그냥 안 보여주면 됨)
 */
...
function getStockDesc(stockName) {
  return STOCK_DESCRIPTIONS[stockName] || "";
}
